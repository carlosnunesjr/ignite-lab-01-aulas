...
class ApolloGateway {
            ...
            if (this.experimental_didUpdateSupergraph) {
                this.experimental_didUpdateSupergraph({
                    ...
                    ? {
                        ...
                        supergraphSdl: (0, graphql_1.print)(previousSupergraphSdl),
    ...
    updateWithSchemaAndNotify(coreSchema, coreSupergraphSdl, legacyDontNotifyOnSchemaChangeListeners = false) {
        ...
        this.schema = (0, query_planner_1.toAPISchema)(coreSchema);
    ...
    createSchemaFromSupergraphSdl(supergraphSdl) {
        const core = core_schema_1.CoreSchema.fromSource(new graphql_1.Source(supergraphSdl, 'supergraphSdl'))
            .check()
            .check(core_1.featureSupport);
        this.parsedSupergraphSdl = core.document;
        const schema = (0, query_planner_2.buildComposedSchema)(this.parsedSupergraphSdl);
